...
define( 'CONNEXFM_ACF_VERSION', '0.1.2' );
define( 'CONNEXFM_ACF_PLUGIN_DIR', dirname( __FILE__ ) );
define( 'CONNEXFM_ACF_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
define( 'CONNEXFM_ACF_PLUGIN_BLOCKS', CONNEXFM_ACF_PLUGIN_DIR . '/blocks/' );
